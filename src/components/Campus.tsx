                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0">
                        ...
                        <div className="relative">
                          <div
                            className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full border-2 border-white shadow-lg transition-all duration-300 ${
                              hoveredCampus === "Paris"
                                ? "w-4 h-4 sm:w-5 sm:h-5 bg-[#f43f5e]"
                                : "bg-[#6366f1] group-hover:w-4 group-hover:h-4 sm:group-hover:w-5 sm:group-hover:h-5 group-hover:bg-[#f43f5e]"
                            }`}
                          ></div>
                          <div
                            className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full absolute -top-1.5 -left-1.5 sm:-top-2 sm:-left-2 animate-pulse ${
                              hoveredCampus === "Paris" ? "bg-[#f43f5e]/30" : "bg-[#6366f1]/30"
                            }`}
                          ></div>
                          <div className="absolute -top-6 sm:-top-8 left-1/2 -translate-x-1/2 bg-gray-900 text-white px-2 py-1 rounded text-xs font-semibold opacity-0 group-hover:opacity-100 whitespace-nowrap">
                            Paris
                          </div>
                        </div>
                      </button>
                      ...
                      >
                        <div className="relative">
                          <div
                            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full border-2 border-white shadow-lg transition-all duration-300 ${
                              hoveredCampus === "Saint-Quentin en Yvelines"
                                ? "w-3 h-3 sm:w-4 sm:h-4 bg-[#f43f5e]"
                                : "bg-[#6366f1] group-hover:w-3 group-hover:h-3 sm:group-hover:w-4 sm:group-hover:h-4 group-hover:bg-[#f43f5e]"
                            }`}
                          ></div>
                          <div
                            className={`w-4 h-4 sm:w-6 sm:h-6 rounded-full absolute -top-1 -left-1 sm:-top-1.5 sm:-left-1.5 animate-pulse ${
                        ...
                        <div className="relative">
                          <div
                            className={`w-3 h-3 rounded-full border-2 border-white shadow-lg transition-all duration-300 ${
                              hoveredCampus === "Val d'Europe"
                                ? "w-4 h-4 bg-[#f43f5e]"
                                : "bg-[#6366f1] group-hover:w-4 group-hover:h-4 group-hover:bg-[#f43f5e]"
                            }`}
                          ></div>
                          <div
                            className={`w-6 h-6 rounded-full absolute -top-1.5 -left-1.5 animate-pulse ${
                              hoveredCampus === "Val d'Europe" ? "bg-[#f43f5e]/30" : "bg-[#6366f1]/30"
                            }`}
                          ></div>
                          <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-gray-900 text-white px-2 py-1 rounded text-xs font-semibold opacity-0 group-hover:opacity-100 whitespace-nowrap">
                            Val d'Europe
                          </div>
                        </div>
                      </button>
                ...
                {campusData.map((campus, index) => (
                  <div
                    ...
                    className={`bg-gray-900/50 rounded-xl p-3 sm:p-4 border transition-all duration-300 transform group cursor-pointer ${
                      hoveredCampus === campus.name
                        ? "scale-105 bg-gray-800/50 dark:bg-white/90"
                        : "hover:scale-105 hover:bg-gray-800/50 dark:bg-white/90"
                  ...
                  >
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      ...
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gray-800 dark:bg-gray-200 rounded-lg overflow-hidden flex-shrink-0">
                        ...
                        <div
                          className="w-full h-full bg-gradient-to-br from-[#6366f1]/20 to-purple-600/20 flex items-center justify-center"
                          style={{ display: "none" }}
                        >
                      ...
                      <div className="flex-1">
                        <h4
                          className={`font-bold text-lg mb-1 transition-colors ${
                            hoveredCampus === campus.name
                              ? "text-[#6366f1]"
                              : "text-white dark:text-gray-800 group-hover:text-[#6366f1]"
